    ...
    <div ref={containerRef} className={clsx("w-full", className)}>
      ...
      <div className="relative">
        <button
          ...
          className={clsx(
            "flex min-h-12 w-full items-center justify-between rounded-[14px] border bg-white px-4 py-3 text-left text-[14px] font-medium outline-none transition",
            error
        ...
        >
          <span
            className={clsx(
              ...
              selectedOptions.length ? "text-[#0B1220]" : "text-[#99A8B8]",
            )}
          >
              ...
              {filteredOptions.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={clsx(
                      "flex w-full items-center justify-between gap-3 rounded-xl px-3 py-2.5 text-left text-[14px] transition",
                      active
                  ...
                  >
                    ...
                    <span
                      className={clsx(
                        ...
                        active
                          ? "border-[#139FDA] bg-[#139FDA] text-white"
                          : "border-[#C7D6E2] bg-white text-transparent",
                      )}
                    >
                      <FiCheck />
                    </span>
